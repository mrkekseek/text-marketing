<div class="page page-table" ng-controller="MarketingSettingsCtrl">
	<h2>
		Setting
	</h2>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" ng-model="team.company_name" placeholder="Enter Team Name" maxlength="32">
							</div>
							...
							<div class="form-group " ng-repeat="input in team.phones track by $index">
								<div class="input-group">
									<input type="text" name="phone-@{{$index + 1}}" class="form-control" placeholder="Enter phone here..." ng-model="team.phones[$index]">
							...
							<div class="form-group ">
								<div class="input-group">
									<input type="text" name="phone-1" class="form-control" placeholder="Enter phone here..." ng-model="input">
									<span class="input-group-btn ">
