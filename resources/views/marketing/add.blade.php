				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6 col-xs-12 form-group">
							<div class="chars-area" ng-class="{'danger': message.messagesTextLength > 130}">
								<label>Message Text</label>
								<textarea id="messagesText" class="form-control" placeholder="Message Text" ng-model="message.messagesText" ng-keyup="charCount('messagesText')">
								</textarea>
								<span>
									<span ng-show="message.messagesTextLength > 130">3 messages </span>
									<span>@{{ message.messagesTextLength }}</span> /
									<span>@{{ message.maxLength }}</span>
						...
						<div class="col-lg-6 col-xs-12 form-group">
							...
							<div class="chars-area" ng-class="{'danger': message.followupTextLength > 130}">
								<div>
								...
								<textarea id="followupText" class="form-control" placeholder="Follow Up Text" ng-model="message.followupText" ng-keyup="charCount('followupText')"></textarea>
								<span >
									<span>@{{ message.followupTextLength }}</span> / <span>130</span>
								</span>
							</div>
							<div ng-show="!show_followup_text_url" class="btn-group btn-group-justified move-top-pixel">
								...
								<div class="btn-group">
									<button type="button" ng-click="insertMask('followupText', '[$FirstName]')" class="btn btn-sm btn-default"><i class="fa fa-user"></i> First Name</button>
								</div>

								<div class="btn-group">
									<button type="button" ng-click="insertMask('followupText', '[$LastName]')" class="btn btn-sm btn-default"><i class="fa fa-user-o"></i> Last Name</button>
								</div>
							</div>
							...
							<div ng-show="show_followup_text_url" class="input-group short-url-box">
								...
								<div class="input-group-btn">
									<button ng-click="insertShortLink('followupText', short_link_followup_text)" type="button" class="btn btn-sm btn-primary">
							...
							<div class="vertical-magin-container">
								<label class="ui-radio"><input name="followupSetting" ng-model="message.followupSettings" type="radio" value="10"><span>After 10m</span></label>
								<label class="ui-radio"><input name="followupSetting" ng-model="message.followupSettings" type="radio" value="20"><span>After 20m</span></label>
								<label class="ui-radio"><input name="followupSetting" ng-model="message.followupSettings" type="radio" value="30"><span>After 30m</span></label>
							</div>
						</div>
						...
						<div class="col-xs-12">
							...
							<div ng-show="message.messagesSchedule == '1'">
								<div class="calendar-container" min="minDate">
									<div uib-datepicker="" ng-model="message.sendDate" class="well well-sm" role="application" datepicker-options="dateOpt">
									</div>
								</div>
